...
const STATUS_STYLES = {
  ...
  rejected: { cls: 'bg-gray-100 dark:bg-gray-700/50 text-gray-600 dark:text-gray-400', icon: <AlertCircle size={13} /> }
}
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Here's a summary of your stays and activity</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card p-5">
          ...
          {bookings.length === 0 ? (
            <div className="text-center py-8">
              <Calendar size={32} className="mx-auto text-gray-200 dark:text-gray-700 mb-2" />
            ...
            <div className="space-y-3">
              {bookings.slice(0, 4).map(b => {
                ...
                return (
                  <div key={b._id} className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-gray-900 dark:text-white truncate">{b.property?.title}</p>
        ...
        <div className="card p-5">
          ...
          {payments.length === 0 ? (
            <div className="text-center py-8">
              <CreditCard size={32} className="mx-auto text-gray-200 dark:text-gray-700 mb-2" />
              <p className="text-sm text-gray-400 dark:text-gray-500">No payments yet</p>
            </div>
          ) : (
            <div className="space-y-3">
              {payments.slice(0, 5).map(p => (
                <div key={p._id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
                  <div className="flex-1 min-w-0">
                  ...
                  <div className="text-right shrink-0">
                    <p className="font-semibold text-sm text-gray-900 dark:text-white">₹{p.amount.total.toLocaleString()}</p>
                    <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${PAYMENT_STYLES[p.status] || 'bg-gray-100 dark:bg-gray-700/50 text-gray-600 dark:text-gray-400'}`}>
