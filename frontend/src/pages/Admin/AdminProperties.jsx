...
import { Building, Search, MapPin, Star, CheckCircle, XCircle, Trash2, RefreshCw, BadgeCheck, Sparkles } from 'lucide-react'
...
function PropertyRow({ property, onUpdate, onDelete }) {
  ...
  return (
    <div className={`border rounded-xl p-4 transition-colors ${
      property.status === 'suspended' ? 'border-red-100 bg-red-50/20' : 'border-gray-100 hover:bg-gray-50'
    }`}>
        ...
        <div className="flex flex-col gap-2 shrink-0 items-end">
          ...
          <div className="flex gap-1.5">
            <button
              ...
              className={`p-2 rounded-lg text-xs font-medium transition-colors disabled:opacity-50 flex items-center gap-1 ${
                property.isVerified
